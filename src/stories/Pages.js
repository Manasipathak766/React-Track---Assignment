...
import { card1 } from "../images/Exterior.jpg";
          ...
          <div className="absolute top-[35px] left-[calc(50%_-_528px)] flex flex-col items-start justify-start">
            <div className="flex flex-col items-start justify-start gap-[32px]">
              ...
              <div className="flex flex-row items-start justify-start gap-[20px] text-sm">
                ...
                <div className="hover:shadow-lg cursor-pointer relative rounded-md bg-white-high-emphasis box-border w-[436px] h-[337px] overflow-hidden shrink-0 text-sm text-gray1-500 border-[1px] border-solid border-gray-divider">
              ...
              <div className="flex flex-col items-start justify-start gap-[18px]">
                ...
                <div className="flex flex-row items-start justify-start gap-[12px] text-smi text-dimgray-200">
                  <div className="hover:shadow-lg cursor-pointer rounded flex flex-col items-start justify-end p-3 gap-[10px] border-[1px] border-solid border-gray-divider">
                    ...
                    <div className="hover:shadow-lg cursor-pointer flex flex-col items-start justify-start gap-[6px] text-sm text-gray1-500">
                      <div className="relative tracking-[0.1px] font-semibold">
                        Recording_0121
                      </div>
